...
scp -o StrictHostKeyChecking=no -i /home/kpihx/.ssh/id_ed25519_pve "${TMP_KEYS}" kpihx-pve:/tmp/sshkeys_${VMID}.tmp
ssh -o StrictHostKeyChecking=no -i /home/kpihx/.ssh/id_ed25519_pve kpihx-pve "sudo qm set ${VMID} --sshkeys /tmp/sshkeys_${VMID}.tmp && rm -f /tmp/sshkeys_${VMID}.tmp"
